...
# =========================================================
# Phase 8 Helper Aliases (Governance Instruction)
# Purpose:
#   Provide simplified helpers while preserving
#   canonical key generation through existing functions.
#
#   NO duplication of key format logic.
# =========================================================


def session_index_key(tenant_id: str) -> str:
    return tenant_session_index_key(tenant_id)


def session_key(tenant_id: str, sid: str) -> str:
    return tenant_session_key(tenant_id, sid)
